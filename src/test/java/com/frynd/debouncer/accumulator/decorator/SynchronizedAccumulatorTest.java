...
class SynchronizedAccumulatorTest {
    ...
    @RepeatedTest(10)//Due to non-deterministic nature, even non-synchronized version can frequently pass
    @DisplayName("Synchronized accumulator should handle multiple threads attempting access simultaneously.")
    ...
    @RepeatedTest(10)//Due to non-deterministic nature, even non-synchronized version can frequently pass
    @DisplayName("Synchronized accumulator should be able to drain mid-accumulate storm.")
